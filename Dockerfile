...
ENV PATH "${PATH}:${ANDROID_HOME}/build-tools/33.0.3"
...
RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "cmdline-tools;26.1.1"
RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "build-tools;33.0.3"
