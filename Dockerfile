...
RUN dpkg --add-architecture i386 && \
    apt-get update -yqq && \
    apt-get install -y sudo openjdk-17-jdk curl expect git libc6:i386 libgcc1:i386 libncurses5:i386 libstdc++6:i386 zlib1g:i386 openjdk-11-jdk wget unzip vim && \
    apt-get clean
